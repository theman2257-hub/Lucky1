...
const Cards = ({ endDate, image, name, ticketPrice, to, lotteryAddress, maxTickets, tokenSymbol }) => {
    ...
    <>
      <div className={styles.card} onClick={
        ...
        <img
          ...
          src={`https://api.lucky1.io/images/${lotteryAddress}.png?32437828`} alt="#" className={styles.image} />
        {/* <p className={styles.name}>{name}</p> */}
        <p className={styles.name}> {Number(ticketPrice * (maxTickets / 10 ** 18)).toFixed(2)} {tokenSymbol}</p>
